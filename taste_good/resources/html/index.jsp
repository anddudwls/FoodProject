...
<c:set var="path1" value="${pageContext.request.contextPath }/resources" />
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
   ...
   <link href="${path1}/css/style.css" rel="stylesheet">
...
<body>
    ...
    <div id="preloader">
        ...
        <img src="${path1}/img/core-img/salad.png" alt="">
    </div>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="deliciousNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="index.jsp"><img src="${path1}/img/core-img/logo.png" alt=""></a>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="receipe-post.jsp">Receipe Post</a></li>
                                        ...
                                        <div class="megamenu">
                                            ...
                                            <div class="single-mega cn-col-4">
                                                <div class="receipe-slider owl-carousel">
                                                    <a href="#"><img src="${path1}/img/bg-img/bg1.jpg" alt=""></a>
                                                    <a href="#"><img src="${path1}/img/bg-img/bg6.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li><a href="receipe-post.jsp">Receipies</a></li>
                                    <li><a href="receipe-post.jsp">4 Vegans</a></li>
                                    <li><a href="contact.jsp">Contact</a></li>
                                </ul>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(${path1}/img/bg-img/bg7.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-catagory">
                        ...
                        <div class="top-cta-content">
                            ...
                            <a href="receipe-post.jsp" class="btn delicious-btn">See Full Receipe</a>
                        </div>
                    </div>
                </div>
                <!-- Top Catagory Area -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="${path1}/img/bg-img/r1.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.jsp">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="${path1}/img/bg-img/r2.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.jsp">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="${path1}/img/bg-img/r3.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.jsp">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="${path1}/img/bg-img/r4.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.jsp">
                                <h5>Calabasa soup</h5>
                            </a>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="${path1}/img/bg-img/r5.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.jsp">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="${path1}/img/bg-img/r6.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.jsp">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        ...
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr1.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        <!-- Receipe Thumb -->
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr2.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        <!-- Receipe Thumb -->
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr3.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        <!-- Receipe Thumb -->
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr4.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        <!-- Receipe Thumb -->
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr5.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        <!-- Receipe Thumb -->
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr6.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        <!-- Receipe Thumb -->
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr7.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        <!-- Receipe Thumb -->
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr8.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        <!-- Receipe Thumb -->
                        <div class="receipe-thumb">
                            <img src="${path1}/img/bg-img/sr9.jpg" alt="">
                        </div>
                        <!-- Receipe Content -->
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
            ...
            <div class="row align-items-end">
                ...
                <div class="col-12 col-lg-4">
                    <div class="newsletter-area">
                        ...
                        <!-- Form -->
                        <div class="newsletter-form bg-img bg-overlay" style="background-image: url(${path1}/img/bg-img/bg1.jpg);">
                            <form action="#" method="post">
                ...
                <div class="col-12 col-lg-4">
                    <div class="delicious-add">
                        <img src="${path1}/img/bg-img/add.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="follow-us-instagram">
        ...
        <div class="insta-feeds d-flex flex-wrap">
            ...
            <div class="single-insta-feeds">
                <img src="${path1}/img/bg-img/insta1.jpg" alt="">
                <!-- Icon -->
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="${path1}/img/bg-img/insta2.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="${path1}/img/bg-img/insta3.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="${path1}/img/bg-img/insta4.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="${path1}/img/bg-img/insta5.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="${path1}/img/bg-img/insta6.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="${path1}/img/bg-img/insta7.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <div class="row h-100">
                <div class="col-12 h-100 d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="footer-logo">
                        <a href="index.jsp"><img src="${path1}/img/core-img/logo.png" alt=""></a>
                    </div>
                    <!-- Copywrite -->
